...
/** Stable same-origin marker that lets a WebView read an isolated-cached body image. */
public final class LinuxDoMediaProxy {
    private static final String PREFIX =
            "https://linux.do/__nga_media_proxy?src=";

    public static String wrap(String sourceUrl) {
